...
#include <iostream>
#include "op3_arm_kinematics/mod_op3_kinematics_dynamics.h"

namespace robotis_op
{

ModOP3KinematicsDynamics::ModOP3KinematicsDynamics()
{
}
ModOP3KinematicsDynamics::~ModOP3KinematicsDynamics()
{
...
ModOP3KinematicsDynamics::ModOP3KinematicsDynamics(TreeSelect tree)
{
  ...
  if (tree == WholeBody)
  {
    ...
    op3_link_data_[5]->relative_position_ = robotis_framework::getTransitionXYZ(0.0275, -0.0625, 0.0);
    ...
    op3_link_data_[21]->relative_position_ = robotis_framework::getTransitionXYZ(0.13, -0.13, 0.0);
    ...
    op3_link_data_[6]->relative_position_ = robotis_framework::getTransitionXYZ(0.0275, 0.0625, 0.0);
    ...
    op3_link_data_[22]->relative_position_ = robotis_framework::getTransitionXYZ(0.13, 0.13, 0.0);
...
std::vector<int> ModOP3KinematicsDynamics::findRoute(int to)
{
...
std::vector<int> ModOP3KinematicsDynamics::findRoute(int from, int to)
{
  int id = op3_link_data_[to]->parent_;
...
double ModOP3KinematicsDynamics::calcTotalMass(int joint_id)
{
  double mass;
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcMC(int joint_id)
{
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcCOM(Eigen::MatrixXd mc)
{
  double mass;
...
void ModOP3KinematicsDynamics::calcForwardKinematics(int joint_id)
{
  if (joint_id == -1)
    return;
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcJacobian(std::vector<int> idx)
{
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcJacobianCOM(std::vector<int> idx)
{
  int idx_size = idx.size();
  int end = idx_size - 1;
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcVWerr(Eigen::MatrixXd tar_position, Eigen::MatrixXd curr_position,
...
bool ModOP3KinematicsDynamics::calcInverseKinematics(int to, Eigen::MatrixXd tar_position, Eigen::MatrixXd tar_orientation,
...
bool ModOP3KinematicsDynamics::calcInverseKinematics(int from, int to, Eigen::MatrixXd tar_position,
...
bool ModOP3KinematicsDynamics::calcInverseKinematicsForLeg(double *out, double x, double y, double z, double roll,
...
bool ModOP3KinematicsDynamics::calcInverseKinematicsForRightLeg(double *out, double x, double y, double z, double roll,
                                                             double pitch, double yaw)
{
...
bool ModOP3KinematicsDynamics::calcInverseKinematicsForLeftLeg(double *out, double x, double y, double z, double roll,
                                                            double pitch, double yaw)
{
  if (calcInverseKinematicsForLeg(out, x, y, z, roll, pitch, yaw) == true)
  {
...
LinkData *ModOP3KinematicsDynamics::getLinkData(const std::string link_name)
{
...
LinkData *ModOP3KinematicsDynamics::getLinkData(const int link_id)
{
...
Eigen::MatrixXd ModOP3KinematicsDynamics::getJointAxis(const std::string link_name)
{
...
double ModOP3KinematicsDynamics::getJointDirection(const std::string link_name)
{
...
double ModOP3KinematicsDynamics::getJointDirection(const int link_id)
{
  double joint_direction = 0.0;
...
Eigen::MatrixXd ModOP3KinematicsDynamics::calcPreviewParam(double preview_time, double control_cycle,
                                                        double lipm_height,
